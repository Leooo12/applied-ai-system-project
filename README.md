...
The original Module 1-3 project was the **Music Recommender Simulation**. It
...
The original Module 1-3 evaluation harness is unchanged and still works:
